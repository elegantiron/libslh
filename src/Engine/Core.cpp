...
void Core::init(sf::VideoMode mode, const sf::String &title, bool &successful) {
...
const sf::RenderWindow &Core::getWindow() const { return _window; }

void Core::setNextScene(ScenePtr pScene) {
  _sceneMan.setNextScene(std::move(pScene));
}

ScenePtr Core::getCurrentScene() const { return _sceneMan.getCurrentScene(); }

std::basic_string<char>
Core::localize(const boost::locale::basic_message<char> &string) {
